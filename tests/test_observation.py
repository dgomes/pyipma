from pyipma.observation import Observations


async def test_observations(static_api, load_fixture):
    api = static_api(
        {
            "https://api.ipma.pt/open-data/observation/meteorology/stations/observations.json": load_fixture(
